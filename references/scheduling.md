...
- Any miss → `box: 1`, `streak: 0`, `next_review: today+1`, append
  ...
  session's scaffolding question is built from this line. Keep it under
  ~8 words and comma-free. Boxes fall hard on a true miss on purpose —
  relearning is cheaper than false confidence.
